  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
      ...
      children: [
        ...
        // Disabled, not wired: cut for the deadline (agreed 2026-08-26) -
        // there is no district-aggregate feature built yet (out of scope,
        // officer console). Rendered for visual parity with the reference
        // without pretending it does something.
        OutlinedButton(
          onPressed: null,
